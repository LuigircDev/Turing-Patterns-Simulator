 ...
 */var Og;function xx(){if(Og)return go;Og=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:c}}return go.Fragment=e,go.jsx=i,go.jsxs=i,go}var Pg;function Sx(){return Pg||(Pg=1,Af.exports=xx()),Af.exports}var un=Sx(),Rf={exports:{}},ie={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`;function Ib(o,e=200,i=200,r=.06,l=.045,c,h=1){const d=Ce.useRef(r),m=Ce.useRef(l),p=Ce.useRef(c),g=Ce.useRef(h),v=Ce.useRef(null),S=Ce.useRef(null),y=Ce.useRef(null),A=Ce.useRef([]),C=Ce.useRef(null),M=Ce.useRef(null),_=Ce.useRef(null),B=Ce.useRef(null),N=Ce.useCallback(()=>{if(!o.current)return;const I=new Bb({canvas:o.current,preserveDrawingBuffer:!0,alpha:!0});I.setSize(e,i),v.current=I;const V=new p_;S.current=V;const z=new fv(-1,1,1,-1,0,1);y.current=z;const X=[];for(let ot=0;ot<2;ot++){const rt=new Ha(e,i,{minFilter:Kn,magFilter:Kn,format:oi,type:Ai,stencilBuffer:!1});X.push(rt)}A.current=X;const w=new _i({uniforms:{tSource:{value:null},dA:{value:1},dB:{value:.25},feed:{value:d.current},kill:{value:m.current},resolution:{value:new be(e,i)}},fragmentShader:zb,vertexShader:lh});M.current=w;const R=new _i({uniforms:{tSource:{value:null},useFunkyColor:{value:p.current===Kh},resolution:{value:new be(e,i)}},fragmentShader:Fb,vertexShader:lh});C.current=R;const H=new gi(new Ss(2,2),R);V.add(H),_.current=H,U()},[e,i,o]),U=Ce.useCallback(()=>{if(!A.current[0]||!v.current||!y.current)return;const I=v.current,V=y.current,z=new p_,X=new _i({uniforms:{resolution:{value:new be(e,i)}},fragmentShader:`
      ...
      `,vertexShader:lh}),w=new gi(new Ss(2,2),X);z.add(w);for(let R=0;R<A.current.length;R++)I.setRenderTarget(A.current[R]),I.render(z,V);I.setRenderTarget(null),w.geometry.dispose(),X.dispose()},[e,i]);return Ce.useEffect(()=>{d.current=r,M.current&&(M.current.uniforms.feed.value=r)},[r]),Ce.useEffect(()=>{m.current=l,M.current&&(M.current.uniforms.kill.value=l)},[l]),Ce.useEffect(()=>{p.current=c,C.current&&(C.current.uniforms.useFunkyColor.value=c===Kh)},[c]),Ce.useEffect(()=>{g.current=h},[h]),Ce.useEffect(()=>(N(),()=>{B.current&&cancelAnimationFrame(B.current),v.current&&v.current.dispose(),A.current&&A.current.forEach(I=>I.dispose()),M.current&&M.current.dispose(),C.current&&C.current.dispose(),_.current&&_.current.geometry.dispose()}),[N]),Ce.useEffect(()=>{if(!v.current||!S.current||!y.current)return;const I=v.current,V=S.current,z=y.current,X=M.current,w=C.current,R=A.current;let H=0,ot=1;const rt=()=>{for(let dt=0;dt<g.current;dt++)X.uniforms.tSource.value=R[H].texture,_.current.material=X,I.setRenderTarget(R[ot]),I.render(V,z),I.setRenderTarget(null),[H,ot]=[ot,H];w.uniforms.tSource.value=R[H].texture,_.current.material=w,I.setRenderTarget(null),I.render(V,z),B.current=requestAnimationFrame(rt)};return rt(),()=>{B.current&&cancelAnimationFrame(B.current)}},[]),{resetGrid:U}}const Hb=(o,e)=>{const i=Math.floor((o-e)*255);return`rgb(${i}, ${i}, ${i})`},Kh=(o,e)=>{const i=Math.floor(255*(o*e)),r=Math.floor(255*(1-o)),l=Math.floor(255*(1-e));return`rgb(${i}, ${r}, ${l})`};function Gb(){const o=Ce.useRef(null),[e,i]=Ce.useState(.055),[r,l]=Ce.useState(.062),[c,h]=Ce.useState(400),[d,m]=Ce.useState(1),[p,g]=Ce.useState("default"),[v,S]=Ce.useState(0),{resetGrid:y}=Ib(o,c,c,e,r,p==="funky"?Kh:Hb,d);Ce.useEffect(()=>{v>0&&y()},[v,y]);const A=()=>{S(_=>_+1)},C=()=>{i(Math.random()*.09+.01),l(Math.random()*.04+.03),S(_=>_+1)},M=()=>{g(_=>_==="default"?"funky":"default")};return un.jsxs("div",{className:"min-h-screen bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center justify-center p-8 gap-8",children:[un.jsx("h1",{className:"text-4xl font-mono text-white",children:"Turing Patterns Simulator 🎨 (GPU Edition)"}),un.jsx("canvas",{ref:o,className:"border-4 border-cyan-400 rounded-xl shadow-lg",width:c,height:c}),un.jsxs("div",{className:"bg-gray-800 p-6 rounded-lg shadow-md flex flex-col gap-4 w-80",children:[un.jsxs("div",{className:"flex flex-col",children:[un.jsxs("label",{className:"text-cyan-400 font-mono mb-1",children:["Feed: ",e.toFixed(4)]}),un.jsx("input",{type:"range",min:"0.01",max:"0.1",step:"0.001",value:e,onChange:_=>i(parseFloat(_.target.value)),className:"w-full accent-cyan-400"})]}),un.jsxs("div",{className:"flex flex-col",children:[un.jsxs("label",{className:"text-cyan-400 font-mono mb-1",children:["Kill: ",r.toFixed(4)]}),un.jsx("input",{type:"range",min:"0.03",max:"0.07",step:"0.001",value:r,onChange:_=>l(parseFloat(_.target.value)),className:"w-full accent-cyan-400"})]}),un.jsxs("div",{className:"flex flex-col",children:[un.jsxs("label",{className:"text-cyan-400 font-mono mb-1",children:["Velocidad: ",d,"x"]}),un.jsx("input",{type:"range",min:"1",max:"20",step:"1",value:d,onChange:_=>m(parseInt(_.target.value)),className:"w-full accent-cyan-400"})]}),un.jsxs("div",{className:"flex flex-col gap-2 pt-4",children:[un.jsx("button",{onClick:A,className:"bg-cyan-600 hover:bg-cyan-500 text-white font-mono py-2 rounded-lg transition",children:"🔄 Reiniciar Simulación"}),un.jsx("button",{onClick:C,className:"bg-yellow-600 hover:bg-yellow-500 text-white font-mono py-2 rounded-lg transition",children:"🎲 Randomizar Parámetros"}),un.jsx("button",{onClick:M,className:"bg-pink-600 hover:bg-pink-500 text-white font-mono py-2 rounded-lg transition",children:"🎨 Cambiar Color"})]})]})]})}Dx.createRoot(document.getElementById("root")).render(un.jsx(yx.StrictMode,{children:un.jsx(Gb,{})}));
